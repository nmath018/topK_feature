...
HD_PWD='/home/nmath018/topK_feature/hls_catch22/_x.hw.xilinx_u250_gen3x16_xdma_4_1_202210_1/link/vivado/vpl/prj/prj.runs/ulp_topKQueryScores_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ulp_topKQueryScores_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ulp_topKQueryScores_1_0.tcl
