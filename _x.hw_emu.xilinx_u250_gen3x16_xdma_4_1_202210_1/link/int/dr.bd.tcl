...
#---------------------------
# Instantiating topKQueryScores_1
#---------------------------
set topKQueryScores_1 [create_bd_cell -type ip -vlnv xilinx.com:hls:topKQueryScores:1.0 topKQueryScores_1]
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins -auto_enable /topKQueryScores_1/s_axi_control] \

connect_bd_net  \
  [get_bd_pins -auto_enable /kernel_clk/clk] \
  [get_bd_pins -auto_enable /topKQueryScores_1/ap_clk] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /topKQueryScores_1/ap_rst_n] \

connect_bd_net  \
  [get_bd_pins -auto_enable /topKQueryScores_1/interrupt] \
...
sdx_memory_subsystem::map_memory_resource \
  [get_bd_intf_pins -auto_enable /topKQueryScores_1/m_axi_gmem] \
