...
#HOST_SRCS = $(wildcard $(SRCDIR)/*.h)
HOST_SRCS += ./src/host.cpp 
HOST_SRCS += ./src/helper_functions.h
HOST_SRCS += ./src/helper_functions.c
HOST_SRCS += ./src/stats.h
HOST_SRCS += ./src/stats.c
HOST_SRCS += ./src/stats.h
HOST_SRCS += ./src/histcounts.h
HOST_SRCS += ./src/histcounts.c
HOST_SRCS += ./src/DN_HistogramMode_5.h
HOST_SRCS += ./src/DN_HistogramMode_5.c
HOST_SRCS += ./src/DN_HistogramMode_10.h
HOST_SRCS += ./src/DN_HistogramMode_10.c
HOST_SRCS += ./src/MD_hrv.h
HOST_SRCS += ./src/MD_hrv.c
...
# Add krnl2 for two-array functions and load2
$(TEMP_DIR)/krnl.xo: /home/nmath018/topK_feature/hls_catch22/src/krnl.cpp
	mkdir -p $(TEMP_DIR)
	$(VPP) $(VPP_FLAGS) -c -k topKQueryScores --temp_dir $(TEMP_DIR)  -I'$(<D)' -o'$@' $^
BINARY_CONTAINER_krnl_OBJS += $(TEMP_DIR)/krnl.xo
